            ...
            <div className="relative overflow-hidden rounded-lg h-96 lg:h-full">
                {
                    data.map((img,i) => 
                        <div key={i} className="hidden duration-700 ease-in-out" data-carousel-item>
                            <Image width={2000} height={2000} src={`/images/highlights/${img}.jpg`} className="absolute block w-full max-sm:h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                        </div>
                    )
                }
            </div>
