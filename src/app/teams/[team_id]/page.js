        ...
        <div className="max-w-screen-xl m-auto mt-32">
            <div className='w-full flex items-center justify-between'>
                <Image
                    ...
                    width={200}
                    height={200}
                    alt={team_id.toUpperCase()}
                />
                <div className=''>
                    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl dark:text-white">{team_id.toUpperCase()}</h1>
                    <div className='flex justify-center items-center md:mt-0 space-x-5 rtl:space-x-reverse'>
