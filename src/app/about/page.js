  ...
  return (
    <div class="m-auto max-w-screen-xl mt-32 mb-32">
      ...
      <div className="mt-16">
        ...
        <div class="sm:flex justify-center sm:justify-around items-center">
          <div>
            <img src="/images/about/sac_president.jpg" className="w-72 h-72 rounded-xl"></img>
            <h1 className="text-2xl font-bold text-center mt-5">Dr. Lakhendra Murmu</h1>
            <h1 className="text-md text-center mt-1 text-gray-400">SAC President</h1>
          </div>

          <blockquote class="relative w-3/5">
        ...
        <div class="flex justify-around mt-10">
          {
            developers.map((dev,i) => (
              <div className="justify-center" key={i}>
                <img src={`/images/about/developers/${dev.img}`} className="w-56 h-56"></img>
